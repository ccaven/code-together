        ...
        void function () {
            ...
            const wrapText = function (str, width) {
                ...
                while (i < str.length) {
                    ...
                    if (newLineCharIndex >= 0) {
                        ...
                        result += phrase;
                        phrase =
                            frag.slice(newLineCharIndex + 1, frag.length) + " ";
                    } else {
                        phrase += frag + " ";
                ...
                if (msg.includes("\n")) {
                    msg.split("\n").map((p, i) => {
                        ctx.fillText(
                            ...
                            y +
                                (i - (msg.split("\n").length - 1) / 2) *
                                    (skiJSData.height + skiJSData.leading)
                        );
                        ctx.strokeText(
                            p,
                            x,
            ...
            getImage = function (src, width, height) {
                return new Promise((resolve, reject) => {
                    ...
                    img.onerror = () =>
                        reject("invalid or unaccessible image source");
                });
            };           
